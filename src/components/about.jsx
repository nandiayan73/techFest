              ...
              <div className="col-lg-8">
                <div className="section_title text-center mb-80">
                  ...
                  <h3
                    ...
                    data-wow-delay=".3s"
                    style={{ color: "red", opacity: "1", zIndex: "22px" }}
                  >
                    About Program
                  </h3>
                  ...
                  <p
                    ...
                    style={{ opacity: "1" }}
                  >
                    This event occurs at the mid of May every year. It is a
                    stage of bringing out the talents of our students. We bring
                    delight, fun and energy.
                  </p>
                </div>
              </div>
            </div>
            <div className="row align-items-center">
              <div className="col-lg-7 col-md-6">
                <div className="about_thumb">
                  <div
                    className="shap_3  wow fadeInLeft"
                    data-wow-duration="1s"
                    data-wow-delay=".4s"
                  >
                  ...
                  <div
                    className="thumb_inner  wow fadeInUp"
                    data-wow-duration="1s"
                    data-wow-delay=".3s"
                  >
                    <img src="img/assets/INVITATION CARD.jpg" alt=""></img>
                  </div>
                </div>
              </div>
              <div className="col-lg-5 col-md-6">
                <div className="about_info pl-68">
                  ...
                  >
                    ...
                    happens every mid summer.This event offers its audience with
                    energy, entertainment and joy. It is something everyone
                    waits for.
                  </p>
                  <a
                    href="/body"
