            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="section_title text-center mb-80  wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                        <h3 style={{fontFamily:"Arial",fontWeight:"bold"}}>Enthuzea 2023</h3>
                    </div>
                </div>
            </div>
            <center><img src="img/enthu/must.png" style={{width:"55%",borderRadius:"10%"}}></img></center>
            <br></br>
                    ...
                    <div className="program_detail_wrap">
                        ...
                        <div className="single_propram">
                            <div className="inner_wrap">
                                ...
                                <div className="porgram_top">
                                    <span className=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Fakira is here🥰 </span>
                                ...
                                <div className="thumb wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="img/enthu/fakira.jpg" alt=""></img>
                                </div>
                        ...
                        <div className="single_propram">
                            <div className="inner_wrap">
                                <div className="circle_img"></div>
                                <div className="porgram_top">
                                    <span className=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Riddles also here😱</span>
                                    {/* <h4 className=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s" style={{fontFamily:"Arial",fontWeight:"bold"}}>JOY GURU</h4> */}
                                </div>
                                <div className="thumb wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="img/enthu/riddles.jpg" alt=""></img> 
                                </div>
                        ...
                        <div className="single_propram">
                            <div className="inner_wrap">
                                <div className="circle_img"></div>
                                <div className="porgram_top">
                                    <span className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Get to see </span>
                                    <h4 className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Mesmerizing Dance performances💃 </h4>
                                </div>
                        ...
                        <div className="single_propram">
                            <div className="inner_wrap">
                                ...
                                <div className="porgram_top">
                                    ...
                                    {/* <h4 className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Intra College Competetion</h4> */}
                                </div>
                                <div className="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="img/program_details/fashion.jpg" alt=""></img>
                                </div>
                        ...
                        <div className="single_propram">
                            <div className="inner_wrap">
                                <div className="circle_img"></div>
                                <div className="porgram_top">
                                    <span className=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Singing Competetion</span>
